...
@section('content')
    <main class="section-register">
        <section class="section-register--left pt-5">
            <div class="card">
                <div class="card-body">
        ...
        <section class="section-register--right pt-5">
            ...
            <form action="{{route('register.store')}}" method="post">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" class="form-control u-box-shadow-1 @error('name') is-invalid @enderror" name="name" />
                    @error('name')
                ...
                <div class="mt-3">
                    ...
                    <input type="email" class="form-control u-box-shadow-1 @error('email') is-invalid @enderror" name="email" />
                    @error('email')
                    <small class="text-danger">{{$message}}</small>
                    @enderror
                </div>
